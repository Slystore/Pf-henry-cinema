...
const moviesMocks = async() => {
    ...
    const spaceJam = await movies.create({
        ...
        description: "Cuando LeBron y su pequeño hijo Dom quedan atrapados en un espacio digital por una IA deshonesta, LeBron debe llevarlos a casa a salvo liderando a Bugs, Lola Bunny y toda la pandilla de Looney Tunes notoriamente indisciplinados a la victoria sobre los campeones digitalizados de la IA en el Corte. Son Tunes versus Goons en el desafío más importante de su vida.",
        rating: 7.4,
        votes: 2281,
        usersRating: 3.6,
        availability: true,
    ...
    const malignant = await movies.create({
        ...
        description: "Madison está paralizada por visiones impactantes de asesinatos espeluznantes, y su tormento empeora cuando descubre que estos sueños de vigilia son, de hecho, realidades aterradoras con un lazo misterioso con su pasado.",
        rating: 7.1,
        votes: 626,
        usersRating: 1.4,
        availability: true,
