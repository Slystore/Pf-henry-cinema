...
import { getMovies, getUsers, getGenres, getAll } from './actions';
...
function filterPosts(movies, query){
  if (!query) {
      return movies;
  }
...
//     img: './assets/moviesPosters/after_almas_perdimport { getGenres, getAll } from './actions/index';
// idas.jpg'
//    },
//   { id: '2', name: 'Cry Macho' },
